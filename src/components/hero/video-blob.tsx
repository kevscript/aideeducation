...
export function VideoBlob() {
  ...
  return (
    <>
      <div
        className="group hover:scale-125 duration-300 transition w-48 aspect-square bg-navy-700 blobing flex justify-center items-center cursor-pointer"
        onClick={handleVideoOpen}
      >
        <PlayIcon className="w-8 h-8 fill-white md:fill-navy-900 group-hover:fill-white transition" />
      </div>
